...
public class GameOverScreen implements MouseListener{
	...
	public GameOverScreen(JFrame app, boolean playerOneWin){
		...
		if (playerOneWin){
			bImage = new ImageIcon("Player1Win.png");
		}else{
			bImage = new ImageIcon("Player2Win.png");
		}
		...
		backgroundeContainer.setBackground(new Color(0,0,0,0));
		backgroundeContainer.addMouseListener(this);
	}
	
	public void loadEndScreen() {
		window.add(backgroundeContainer); 
		window.setComponentZOrder(backgroundeContainer, 0);

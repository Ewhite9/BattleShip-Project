...
public class GameLogic {
	...
	final public static int boardSize = 10;
	...
	public void startGame(){
		...
		Ship[] p1Ships = initializeShipCreation(false);
	...
	private Ship[] initializeShipCreation(boolean isPlayerOne) {
		Ship[] carriers = createShips(5, 1, isPlayerOne);
		Ship[] battleships = createShips(4, 1, isPlayerOne);
		Ship[] cruisers = createShips(3, 1, isPlayerOne);
		Ship[] submarines = createShips(3, 1, isPlayerOne);
		Ship[] destroyers = createShips(2, 1, isPlayerOne);
		
		Ship[] ships;
		
		ships = concatShipArray(carriers, battleships);
		ships = concatShipArray(ships, cruisers);
